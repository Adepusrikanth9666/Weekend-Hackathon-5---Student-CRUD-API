...
app.post("/api/student",(req,res)=>{
    if(req.body===""||req.body.name===""||req.body.currentClass===""||req.body.division===""){
...
app.put("/api/student/:id",(req,res)=>{
    ...
    if(student!==undefined){
        ...
        if(studentArray[params].name!==req.body.name||studentArray[params].currentClass!==req.body.currentClass||studentArray[params].division!==req.body.division){
...
app.delete("/api/student/:id",(req,res)=>{
    ...
    if(student!==undefined){
        ...
        res.status(400).send("No id is found");
    }
})
